...
public class MeanOfArray {
    public static void main(String[] args) {
        ...
        System.out.println(trimMean(new int[]{4, 8, 4, 10, 0, 7, 1, 3, 7, 8, 8, 3, 4, 1, 6, 2, 1, 1, 8, 0, 9, 8, 0, 3, 9, 10, 3, 10, 1, 10, 7, 3, 2, 1, 4, 9, 10, 7, 6, 4, 0, 8, 5, 1, 2, 1, 6, 2, 5, 0, 7, 10, 9, 10, 3, 7, 10, 5, 8, 5, 7, 6, 7, 6, 10, 9, 5, 10, 5, 5, 7, 2, 10, 7, 7, 8, 2, 0, 1, 1}));
    }
    ...
    public static double trimMean(int[] arr) {
        ...
        int percentageForRemoval = (int) (length * 0.05);

        double sum = 0;
        int start = percentageForRemoval;
        int end = arr.length - percentageForRemoval - 1;

        while (start <= end) {
            sum += arr[start++];
        }

        return sum / (arr.length - (percentageForRemoval * 2));
    }
}
